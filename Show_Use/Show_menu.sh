...
show_soft=("返回主页面" "nginx" "docker+docker-compose" "docker-compose" "jdk" "mysql5" "一键安装所有")
show_soft_function=("return" "install_nginx" "install_docker" "install_docker_compose" "install_jdk" "install_mysql5" "install_all")
